...
export default function SignIn() {
	...
	const handleSignIn = async (e: React.FormEvent<HTMLFormElement>) => {
		...
		// console.log(e)
		try {
			const res = await client.post("/sign-in", { username: usernameInput, password })
        ...
        setUserID(res.data?.id)
			...
			// console.log(err)
			notify("Username not found, please try again", "error")
			console.log(err)
			setIsLoading(false)
		}
	}
									...
									<div>
										...
										<div className='mt-2'>
											<input
												...
												className='indent-4 block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6'
											/>
										</div>
									</div>
